...
<html>
	...
	<body>
		<a href="#edit-invitation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-invitation" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:invitationInstance, action:'update']" method="PUT" >
