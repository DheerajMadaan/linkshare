	...
	<body>
		...
		<div id="show-subscription" class="content scaffold-show" role="main">
			...
			<ol class="property-list subscription">
				...
				<g:if test="${subscriptionInstance?.subscriptionDate}">
				<li class="fieldcontain">
					<span id="subscriptionDate-label" class="property-label"><g:message code="subscription.subscriptionDate.label" default="Subscription Date" /></span>
					
						<span class="property-value" aria-labelledby="subscriptionDate-label"><g:formatDate date="${subscriptionInstance?.subscriptionDate}" /></span>
