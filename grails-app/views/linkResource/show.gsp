	...
	<body>
		...
		<div id="show-linkResource" class="content scaffold-show" role="main">
			...
			<ol class="property-list linkResource">
                ...
                <g:if test="${linkResourceInstance?.topic.topicName}">
                    <li class="fieldcontain">
                        <span id="title-label" class="property-label"><g:message code="documentResource.title.label" default="Topic Name" /></span>

                        <span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${linkResourceInstance}" field="topic.topicName"/></span>
